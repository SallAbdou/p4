...
// inputs Form
export const firstName = document.querySelector("#first");
export const lastName = document.getElementById("last");
export const birthdate = document.querySelector("#birthdate");
export const emailAdd = document.querySelector("#email");
export const quantity = document.querySelector("#quantity");
export const location1 = document.querySelector("#location1");
export const location2 = document.querySelector("#location2");
export const location3 = document.querySelector("#location3");
export const location4 = document.querySelector("#location4");
export const location5 = document.querySelector("#location5");
